...
class EintragTableMap extends TableMap
{
    ...
    /**
     * the column name for the ueberschrift field
     */
    const COL_UEBERSCHRIFT = 'eintrag.ueberschrift';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'Text', 'Datum', 'Ueberschrift', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'text', 'datum', 'ueberschrift', ),
        self::TYPE_COLNAME       => array(EintragTableMap::COL_ID, EintragTableMap::COL_NAME, EintragTableMap::COL_TEXT, EintragTableMap::COL_DATUM, EintragTableMap::COL_UEBERSCHRIFT, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'text', 'datum', 'ueberschrift', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'Text' => 2, 'Datum' => 3, 'Ueberschrift' => 4, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'text' => 2, 'datum' => 3, 'ueberschrift' => 4, ),
        self::TYPE_COLNAME       => array(EintragTableMap::COL_ID => 0, EintragTableMap::COL_NAME => 1, EintragTableMap::COL_TEXT => 2, EintragTableMap::COL_DATUM => 3, EintragTableMap::COL_UEBERSCHRIFT => 4, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'text' => 2, 'datum' => 3, 'ueberschrift' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('ueberschrift', 'Ueberschrift', 'VARCHAR', true, 50, null);
    } // initialize()
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(EintragTableMap::COL_ID, (array) $values, Criteria::IN);
        }
